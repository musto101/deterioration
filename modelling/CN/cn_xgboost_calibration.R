...
grid <- list(alpha = c(0, 0.1, 0.5, 1),
             ...
             nrounds = 1000) # defines the hyperparameter search space.
...
rr$aggregate(msr("surv.calib_alpha")) # saves the final Calibration for the whole dataset, which results from the nested CV process.
