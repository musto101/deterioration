...
dat <- read.csv('data/mci_preprocessed_wo_csf.csv') # reads the cn data into R.
...
# I am noticing that the model built by this process is very unstable giving C-indexes that vary wildly. I got between 0.58-0.72 but you might get different results.
